---
{"dg-publish":true,"permalink":"/study/dl/embedding/"}
---
...
比如一句话，“我爱中国”对应的索引为[0,1,2,3]，要将这个索引转化为固定大小且稠密的向量来表示，而不是稀疏的one-hot编码。可以表示为$[[0.2, 0.5], [0.6,-0.1], [0.8, 0.4], [0.5, 0.5\|0.2, 0.5], [0.6,-0.1], [0.8, 0.4], [0.5, 0.5]]$，。
...
embedding层的具体结构可以与skip-gram模型类比，输入索引，隐含层是embedding的维度，隐含层的权重就是词嵌入。
